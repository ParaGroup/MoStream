...
def run_config(src_degree: Int, alternate_degree_1: Int, alternate_degree_2: Int, sink_degree: Int) raises -> Tuple[Int, Float64]:
...
def main():
    var args = argv()
    if len(args) != 5:
        print("Usage: ./test_image_coop <Source> <Alternate1> <Alternate2> <Sink>")
        return
    try:
        ...
        print("  Configuration: Source=" + String(src_degree) + " Alternate1=" + String(alternate_degree_1) + " Alternate2=" + String(alternate_degree_2) + " Sink=" + String(sink_degree))
        var res = run_config(src_degree, alternate_degree_1, alternate_degree_2, sink_degree)
